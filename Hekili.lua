...
["enabled"] = true,
["action"] = "prescience",
["criteria"] = "( active_dot.prescience < group_members || solo & buff.prescience.remains < gcd.max ) & ( full_recharge_time <= gcd.max * 3 || cooldown.ebon_might.remains <= gcd.max * 3 & ( buff.ebon_might_self.remains - gcd.max * 3 ) <= buff.ebon_might_self.duration * variable.ebon_might_pandemic_threshold || boss & fight_remains <= 30 )",
["cycle_targets"] = 1,
},
{
["enabled"] = true,
...
{
["enabled"] = true,
["criteria"] = "active_dot.ebon_might = 0 || ( buff.ebon_might_self.remains - cast_time ) <= buff.ebon_might_self.duration * variable.ebon_might_pandemic_threshold",
...
["criteria"] = "cooldown.time_skip.up & talent.time_skip.enabled & ! talent.interwoven_threads.enabled || talent.mass_eruption.enabled & talent.overlord.enabled & cooldown.breath_of_eons.remains <= 1 & talent.molten_embers.enabled & active_enemies >= 3 || empowering.fire_breath",
["list_name"] = "fb",
},
{
["enabled"] = true,
...
{
["enabled"] = true,
["criteria"] = "( ( cooldown.ebon_might.remains <= 4 || buff.ebon_might_self.up ) & boss > 15 & raid_event.adds.in > 15 || fight_remains < 30 ) & boss",
["action"] = "breath_of_eons",
},
{
["enabled"] = true,
...
{
["enabled"] = true,
["criteria"] = "evoker.allied_cds_up > 0 || ( raid_event.adds.remains > 13 || raid_event.adds.in > 20 || ! raid_event.adds.exists ) & ( cooldown.breath_of_eons.remains >= variable.hold_empower_for || ! talent.breath_of_eons.enabled || talent.wingleader.enabled & cooldown.breath_of_eons.remains >= variable.hold_empower_for )",
["action"] = "call_action_list",
["list_name"] = "fb",
},
{
...
["cycle_targets"] = 1,
["empower_to"] = "1",
["criteria"] = "fight_remains > duration + 0.2 & buff.ebon_might_self.remains > duration & ( raid_event.adds.remains > 13 || ! raid_event.adds.exists || raid_event.adds.in > 20 ) & ( ! talent.molten_embers.enabled || dot.fire_breath_damage.ticking ) & ( cooldown.breath_of_eons.remains >= variable.hold_empower_for || ! talent.breath_of_eons.enabled || talent.wingleader.enabled & cooldown.breath_of_eons.remains >= variable.hold_empower_for )",
},
{
["enabled"] = true,
...
["empower_to"] = "4",
["cycle_targets"] = 1,
["criteria"] = "fight_remains > 4 & ( talent.font_of_magic.enabled & ( buff.ebon_might_self.remains > duration & ( ! talent.molten_embers.enabled || cooldown.upheaval.remains <= ( 20 + 4 * talent.blast_furnace.enabled - 6 * 3 ) ) || buff.tip_the_scales.up ) || empowering.fire_breath )",
},
{
["enabled"] = true,
["action"] = "fire_breath",
["empower_to"] = "3",
["cycle_targets"] = 1,
["criteria"] = "fight_remains > 8 & ( ( buff.ebon_might_self.remains > duration & ( ! talent.molten_embers.enabled || cooldown.upheaval.remains <= ( 20 + 4 * talent.blast_furnace.enabled - 6 * 2 ) ) || buff.tip_the_scales.up ) || empowering.fire_breath )",
},
{
["enabled"] = true,
["action"] = "fire_breath",
["empower_to"] = "2",
["cycle_targets"] = 1,
["criteria"] = "fight_remains > 12 & ( buff.ebon_might_self.remains > duration & ( ! talent.molten_embers.enabled || cooldown.upheaval.remains <= ( 20 + 4 * talent.blast_furnace.enabled - 6 * 1 ) ) || empowering.fire_breath )",
},
{
["enabled"] = true,
["action"] = "fire_breath",
...
["cycle_targets"] = 1,
["description"] = "Use Primordial Wave as much as possible. Buff with Surge of power on 2 targets if not playing LMT.",
["criteria"] = "spell_targets.chain_lightning = 1 || buff.surge_of_power.up || ! talent.surge_of_power.enabled || maelstrom < 60 - 5 * talent.eye_of_the_storm.enabled || talent.liquid_magma_totem.enabled",
},
{
["enabled"] = true,
...
["criteria"] = "refreshable & active_enemies = 1 & ( dot.flame_shock.remains < 2 || active_dot.flame_shock = 0 ) & ( dot.flame_shock.remains < cooldown.primordial_wave.remains || ! talent.primordial_wave.enabled ) & ( dot.flame_shock.remains < cooldown.liquid_magma_totem.remains || ! talent.liquid_magma_totem.enabled ) & ! buff.surge_of_power.up & talent.fire_elemental.enabled",
},
{
["enabled"] = true,
["action"] = "flame_shock",
...
["criteria"] = "active_dot.flame_shock < active_enemies & spell_targets.chain_lightning > 1 & ( talent.deeply_rooted_elements.enabled || talent.ascendance.enabled || talent.primordial_wave.enabled || talent.searing_flames.enabled || talent.magma_chamber.enabled ) & ( ! buff.surge_of_power.up & buff.stormkeeper.up || ! talent.surge_of_power.enabled || cooldown.ascendance.remains = 0 & talent.ascendance.enabled ) & ! talent.liquid_magma_totem.enabled",
},
{
["enabled"] = true,
["action"] = "flame_shock",
["cycle_targets"] = 1,
["description"] = "{Fire} Spread Flame Shock to multiple targets only if talents were selected that benefit from it.",
["criteria"] = "spell_targets.chain_lightning > 1 & ( talent.deeply_rooted_elements.enabled || talent.ascendance.enabled || talent.primordial_wave.enabled || talent.searing_flames.enabled || talent.magma_chamber.enabled ) & ( buff.surge_of_power.up & ! buff.stormkeeper.up || ! talent.surge_of_power.enabled ) & dot.flame_shock.remains < 6 & talent.fire_elemental.enabled",
},
{
["enabled"] = true,
...
["criteria"] = "dot.flame_shock.remains & cooldown_react & buff.lava_surge.up & talent.fire_elemental.enabled",
},
{
["enabled"] = true,
["action"] = "lava_burst",
...
["action"] = "elemental_blast",
["cycle_targets"] = 1,
["description"] = "{Lightning} Spend if Stormkeeper is active. Spread Lightning Rod to as many targets as possible.",
["criteria"] = "buff.stormkeeper.up & talent.storm_elemental.enabled",
},
{
["enabled"] = true,
...
["action"] = "earth_shock",
["cycle_targets"] = 1,
["description"] = "{Lightning}[2t] Spend if Stormkeeper is active OR Pwave is coming next gcd and you arent specced into LMT. Spread Lightning Rod to as many targets as possible. Use Echoes of Great Sundering.",
["criteria"] = "( cooldown.primordial_wave.remains < gcd.max & talent.surge_of_power.enabled & ! talent.liquid_magma_totem.enabled || buff.stormkeeper.up ) & talent.storm_elemental.enabled & spell_targets.chain_lightning > 1 & talent.echoes_of_great_sundering.enabled & ! buff.echoes_of_great_sundering_es.up",
},
{
["enabled"] = true,
...
["action"] = "lava_burst",
["cycle_targets"] = 1,
["description"] = "{Farseer/ES} Spend all Lava Burst charges in opener to get one Stormkeeper buffed with Surge of Power.",
["criteria"] = "dot.flame_shock.remains > 2 & buff.stormkeeper.up & talent.elemental_reverb.enabled & talent.earth_shock.enabled & time < 10",
},
{
["enabled"] = true,
...
["action"] = "elemental_blast",
["cycle_targets"] = 1,
["description"] = "Spend if close to overcaping.",
...
["criteria"] = "refreshable & buff.primordial_wave.up & buff.stormkeeper.up & maelstrom < 60 - 5 * talent.eye_of_the_storm.enabled - ( 8 + 2 * talent.flow_of_power.enabled ) * active_dot.flame_shock & spell_targets.chain_lightning >= 6 & active_dot.flame_shock < 6",
},
{
["enabled"] = true,
["action"] = "flame_shock",
...
["criteria"] = "talent.echoes_of_great_sundering.enabled & ! buff.echoes_of_great_sundering_eb.up & ( lightning_rod = 0 || maelstrom > variable.mael_cap - 30 )",
},
{
["enabled"] = true,
["action"] = "earth_shock",
["cycle_targets"] = 1,
["description"] = "Use the talents you selected. Spread Lightning Rod to as many targets as possible.",
["criteria"] = "talent.echoes_of_great_sundering.enabled & ! buff.echoes_of_great_sundering_es.up & ( lightning_rod = 0 || maelstrom > variable.mael_cap - 30 )",
},
{
["enabled"] = true,
...
{
["enabled"] = true,
["criteria"] = "! variable.spymaster_in_1st || ( boss & fight_remains < 45 || time < fight_remains & buff.spymasters_report.stack = 40 ) & cooldown.stormkeeper.remains < 5 || boss & fight_remains < 22",
["action"] = "trinket1",
["slot"] = "trinket1",
},
{
["enabled"] = true,
["criteria"] = "! variable.spymaster_in_2nd || ( boss & fight_remains < 45 || time < fight_remains & buff.spymasters_report.stack = 40 ) & cooldown.stormkeeper.remains < 5 || boss & fight_remains < 22",
["action"] = "trinket2",
["slot"] = "trinket2",
},
{
...
{
["enabled"] = true,
["criteria"] = "rage >= 40 || rage >= 50 & talent.barbaric_training.enabled",
["action"] = "revenge",
},
},
["generic"] = {
